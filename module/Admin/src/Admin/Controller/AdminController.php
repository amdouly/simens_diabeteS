...
class AdminController extends AbstractActionController
{
    ...
    public function modifierUtilisateurAction() 
    {
    	...
    	$html ="<script> 
    			  ...
    			  $('#photo').html('<img style=\'width:105px; height:105px;\' src=\'".$chemin."/images/photos_personnel/" . $photo . "  \' >');
...
//   				return $this->redirect()->toRoute('facturation' , array('action' => 'liste-naissance'));
    ...
    public function visualisationAction() {
    	...
    	$html = "<div id='photo' style='float:left; margin-right:20px;' > <img  style='width:105px; height:105px;' src='".$chemin."/images/photos_personnel/" . $photo . "'></div>";
