    ...
    function confirmation(idadmission){
	  $( "#confirmation" ).dialog({
	    resizable: false,
	    height:170,
	    width:435,
	    ...
	    buttons: {
	        "Oui": function() {
	        	vart=tabUrl[0]+'public/consultation/supprimer-admission-patient/idadmission/'+idadmission;
    ...
    function initialisation(){	
	 ...
	 ( {
		  ...
		  "oLanguage": {
			   ...
			   "sAjaxSource": ""+tabUrl[0]+"public/consultation/liste-patients-admis-ajax", 
    ...
    function supprimerAdmission(idadmission){
    	confirmation(idadmission);
