...
function afficherMotif(nbmotif_admission) {
 ...
 if(nbChampMotif == 1){
		$(".supprimerMotif1" ).replaceWith(
				"<img class='supprimerMotif' src='"+tabUrl[0]+"public/images_icons/sup2.png' />"
			);
	}
 ajouterMotif();
 supprimerMotif();
	...
	$('#ajouter_motif_img').click(function(){ 
		...
		if(nbChampMotif == 2){
			...
			$(".supprimerMotif" ).replaceWith(
					"<img class='supprimerMotif1' style='cursor: pointer;' src='"+tabUrl[0]+"public/images_icons/sup.png' title='supprimer' />"
				);
			supprimerLeMotif1();
		}
	});
