...
this.fermer.html("<img style='width:16px; height:16px; cursor:pointer;' onclick='supprimerImage("+cur+");'  class='pikachooseFermerSuppImg' src='../images_icons/delete_16.png' title='supprimer'>"); 
